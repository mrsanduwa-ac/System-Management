...
function handlePasscodeSubmit(){const e=el.passcodeInput.value.trim();e&&validateAndLoadApp(e)};el.passcodeModal&&(el.passcodeSubmitBtn.addEventListener("click",handlePasscodeSubmit),el.passcodeInput.addEventListener("keypress",e=>"Enter"===e.key&&handlePasscodeSubmit()));
